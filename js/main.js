...
$('.kvizsec_mainpage_content_main_slider').slick({
  ...
  infinite: false,
  variableWidth: false,
  prevArrow: $('.kvizsec_mainpage_content_main_slider_buttons_arrowleft'),
  nextArrow: $('.kvizsec_mainpage_content_main_slider_buttons_arrowright')
});
...
$('.kvizsec_mainpage_content_main_slider_modal').slick({
  ...
  infinite: false,
  variableWidth: false,
  prevArrow: $('.kvizsec_mainpage_content_main_slider_modal_buttons_arrowleft'),
  nextArrow: $('.kvizsec_mainpage_content_main_slider_modal_buttons_arrowright')
});
...
function init() {
  ...
  const address = 'г. Владивосток, ул. Ватутина 4а';
